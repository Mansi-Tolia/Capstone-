...
k = kmean(df_scaled, centers=7 , nstart=20, iter.max = 25)
...
# ###################################################################
# 
# radar_act <- df_mean%>%group_by(cluster) %>%
#   summarise(
...
# ###################################################################
# 
# radar_sat <- df_mean%>%group_by(cluster) %>%
#   summarise(
...
# ###################################################################
# 
# radar_npt <- df_mean%>%group_by(cluster) %>%
#   summarise(
...
# ###################################################################
# 
# radar_admissions <- df_mean%>%group_by(cluster) %>%
#   summarise(
