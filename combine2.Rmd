...
predsLin <- predict(fitLin, test)
mean((train$default-predsLin)^2)
mean((test$default-predsLin)^2)

#ridge
fitRidge <- linearRidge(default~., train)
predsRidge <- predict(fitRidge, test)
mean((train$default-predsRidge)^2)
mean((test$default-predsRidge)^2)
