...
#replace with probability of mean
combined_variable$pcuenr2m[is.na(combined_variable$pcuenr2m)] <- rbinom(n=length(combined_variable$pcuenr2m), size=1, prob=mean(combined_variable$pcuenr2m))
combined_variable$pcuenran[is.na(combined_variable$pcuenran)] <- rbinom(n=length(combined_variable$pcuenran), size=1, prob=mean(combined_variable$pcuenran))
combined_variable$pcuenras[is.na(combined_variable$pcuenras)] <- rbinom(n=length(combined_variable$pcuenras), size=1, prob=mean(combined_variable$pcuenras))
combined_variable$pcuenrnh[is.na(combined_variable$pcuenrnh)] <- rbinom(n=length(combined_variable$pcuenrnh), size=1, prob=mean(combined_variable$pcuenrnh))
combined_variable$pcuenrun[is.na(combined_variable$pcuenrun)] <- rbinom(n=length(combined_variable$pcuenrun), size=1, prob=mean(combined_variable$pcuenrun))
